...
Create a folder called "keys" and copy the key you got from [here](https://drive.google.com/drive/folders/1KAym-RpGIDuJiSmMLmpCtGVbhLm4VjTZ) and paste it in the folder as a file called `prod.keys`.
